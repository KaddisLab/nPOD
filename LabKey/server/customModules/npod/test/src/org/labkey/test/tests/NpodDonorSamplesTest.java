...
public class NpodDonorSamplesTest extends StudyBaseTest
{
    ...
    private void testForm()
    {
        clickFolder(getFolderName());
        clickTab(PARTICIPANTTAB_NAME);
        clickButton("New nPOD CaseID");
        waitForElement(Locator.css(".labkey-nav-page-header").withText("UNOS IDs"));
